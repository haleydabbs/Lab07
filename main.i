...
void initialize() {
    ...
    (*(volatile unsigned short*)0x400000A) = ((0)<<2) | ((29)<<8) | (0<<14);


    DMANow(3, furtherTreesTiles, &((charblock *)0x6000000)[0], 3712 / 2);


    DMANow(3, furtherTreesMap, &((screenblock *)0x6000000)[29], 2048 / 2);


    (*(volatile unsigned short*)0x4000008) = ((1)<<2) | ((30)<<8) | (1<<14);
